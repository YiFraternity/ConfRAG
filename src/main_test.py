...
def get_args():
    ...
    parser.add_argument("--config_path", type=str, default='dragin/config/Qwen1.5-7B-Chat/HotpotQA/SeqValueTest.json', help='config path')
    # parser.add_argument("--config_path", type=str, default='dragin/config/Qwen1.5-7B-Chat/HotpotQA/DRAGIN.json', help='config path')
